...
class CampaignSummaryBuilder
{
    public static function build(Get $get): HtmlString
    {
        ...
        $css = '<style>'
            ...
            . '.cs-list-item-name{font-weight:600;color:var(--fi-fg,#111827);}'
            ...
            . '.cs-details summary{padding:12px 16px;cursor:pointer;font-weight:600;font-size:13px;display:flex;align-items:center;gap:8px;background:#f9fafb;user-select:none;list-style:none;}'
